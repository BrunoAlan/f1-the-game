      ...
      <AnimatePresence mode="popLayout">
        {activeCars.map((car, index) => {
          ...
          return (
            ...
            >
              <span className="w-6 text-right text-f1-text/50">
                {index + 1}
              </span>
              <div
              ...
              <span className="text-f1-text/70 w-20 text-right">
                {formatGap(car, index)}
              </span>
            </motion.div>
          )
        ...
        {dnfCars.map(car => {
          ...
          return (
            ...
            >
              <span className="w-6 text-right text-f1-text/30">
                --
              </span>
              <div
                ...
                style={{ backgroundColor: team.primaryColor }}
              />
              <span className="w-10 text-f1-text/30 line-through">
                {driver.shortName}
              </span>
              <span className="flex-1 text-f1-text/20 truncate">
                {team.name}
              </span>
              <span className="text-f1-danger/60 w-20 text-right font-bold">
                DNF
              </span>
            </motion.div>
          )
